...
public abstract class MobSpawnerAbstract {
	...
	public MobSpawnerAbstract() {
		// NeverLessSpigot start - configurable spawner settings
		this.spawnDelay = NeverLessSpigotConfig.spawnersInitialSpawnDelay;
		this.minSpawnDelay = NeverLessSpigotConfig.spawnersMinSpawnDelay;
		this.maxSpawnDelay = NeverLessSpigotConfig.spawnersMaxSpawnDelay;
		this.spawnCount = NeverLessSpigotConfig.spawnersSpawnCount;
		this.spawnRange = NeverLessSpigotConfig.spawnersSpawnRange;
		this.maxNearbyEntities = NeverLessSpigotConfig.spawnersMaxNearbyEntities;
		this.requiredPlayerRange = NeverLessSpigotConfig.spawnersRequiredPlayerRange;
		// NeverLessSpigot end
	}
	...
	public void c() {
		...
		if (this.g()) {
			...
			if (this.a().isClientSide) {
				...
				// NeverLessSpigot start - configurable spawner animations
				if (NeverLessSpigotConfig.spawnerAnimation) {
