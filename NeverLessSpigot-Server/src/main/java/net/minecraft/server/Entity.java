...
public abstract class Entity implements ICommandListener {
	...
	protected volatile long lastHitTime = System.currentTimeMillis();
	...
	public boolean invulnerable; // NeverLessSpigot - private -> public
	...
	public double c(BlockPosition blockposition) {
		...
		// NeverLessSpigot - reduce usage of block position
		return distanceSquared(blockposition.getX(), blockposition.getY(), blockposition.getZ());
	}
	
	// NeverLessSpigot start - reduce usage of blockposition
	...
	public double distanceSqrdAccurate(Entity entity) {
		...
		if (NeverLessSpigotConfig.improvedHitDetection && entity instanceof EntityPlayer && this instanceof EntityPlayer) {
			...
			if (entityPlayer.playerConnection.getClass().equals(PlayerConnection.class)
				...
				loc = NeverLessSpigot.getInstance().getLagCompensator().getHistoryLocation(entityPlayer.getBukkitEntity(),
						player.ping);
			} else {
