...
public class Explosion {
			...
			if (!entity.aW()) {
				if (!entity.dead) {
					...
					if (distanceSquared <= 64.0D && distanceSquared != 0.0D) {
						...
						// NeverLessSpigot start - toggleable async explosions
	...
	public void a(boolean flag) {
		...
		// NeverLessSpigot start - configurable explosion sounds
		if (NeverLessSpigotConfig.explosionSounds) {
		...
		// NeverLessSpigot start - configurable explosion animations
		if (NeverLessSpigotConfig.explosionAnimation) {
		...
		if (this.b) {
			...
			if (explode != null) {
				...
				if (NeverLessSpigotConfig.fireEntityExplodeEvent) {
