...
public class EntityEnderPearl extends EntityProjectile {
	...
	protected void a(MovingObjectPosition movingobjectposition) {
		...
		if (blockPosition != null) {
			...
			boolean collides = NeverLessSpigotConfig.pearlPassthroughTripwire && block == Blocks.TRIPWIRE
					|| NeverLessSpigotConfig.pearlPassthroughCobweb && block == Blocks.WEB
					|| NeverLessSpigotConfig.pearlPassthroughBed && block == Blocks.BED
					|| NeverLessSpigotConfig.pearlPassthroughFenceGate
					...
					|| NeverLessSpigotConfig.pearlPassthroughSlab && (block == Blocks.STONE_SLAB
		...
		if (!this.world.isClientSide) {
			if (entityliving instanceof EntityPlayer) {
				...
				if (entityplayer.playerConnection.a().isConnected() && entityplayer.world == this.world
					...
					location.setX(this.locX);
					location.setY(this.locY);
					location.setZ(this.locZ);

					// Nacho start - Anti ender pearl glitch

					if (NeverLessSpigotConfig.antiEnderPearlGlitch) {
					...
					if (!teleEvent.isCancelled() && !entityplayer.playerConnection.isDisconnected()) {
						...
						NeverLessSpigot.getInstance().getLagCompensator().registerMovement(player, location); // Nacho
