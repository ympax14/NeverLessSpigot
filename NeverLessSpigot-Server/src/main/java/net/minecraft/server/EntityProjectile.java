...
public abstract class EntityProjectile extends Entity implements IProjectile {
	...
	public void t_() {
		...
		if (!this.world.isClientSide) {
			...
			for (int i = 0; i < list.size(); ++i) {
				...
				if (entity1.ad() && (entity1 != entityliving || this.ar >= 5)) {
					...
					if (this instanceof EntityPotion && NeverLessSpigotConfig.smoothPotting && movingobjectposition1 == null
		...
		if (this.V()) {
			final float f4 = 0.25F; // NeverLessSpigot - move this out of for loop and make final
