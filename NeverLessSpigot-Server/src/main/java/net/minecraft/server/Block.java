...
public class Block {
	...
	public static final RegistryBlocks<MinecraftKey, Block> REGISTRY = new RegistryBlocks<MinecraftKey, Block>(Block.a);
	public static final RegistryID<IBlockData> d = new RegistryID<IBlockData>();
	...
	public static void S() {
		...
		a(55, "redstone_wire", (NeverLessSpigotConfig.usePandaWire ? new PandaRedstoneWire() : new BlockRedstoneWire()).c(0.0F)
		...
		while (iterator.hasNext()) {
			block13 = (Block) iterator.next();
			Iterator<IBlockData> iterator1 = block13.P().a().iterator();
