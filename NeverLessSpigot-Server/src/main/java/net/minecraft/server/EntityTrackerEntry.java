...
// NeverLessSpigot - sendPacket methods have been replaced with the queuePacket method
public class EntityTrackerEntry {
	...
	// NeverLessSpigot - re add removed method used by Citizens
	public EntityTrackerEntry(Entity entity, int b, int c, boolean flag) {

		// NeverLessSpigot Start - get the entity's tracker from it's dimension
