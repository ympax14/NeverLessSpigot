...
import me.ympax.neverlessspigot.commons.ConcurrentIntHashMap;
...
public class EntityTracker {
	...
	public IntHashMap<EntityTrackerEntry> trackedEntities = new ConcurrentIntHashMap<>(); // NeverLessSpigot

	private volatile int noTrackDistance = 0; // NeverLessSpigot - volatile
	...
	// IonSpigot start
	protected EntityTrackerEntry createTracker(Entity entity, int i, int j, boolean flag) { // NeverLessSpigot - protected
		if (entity.isCannoningEntity && NeverLessSpigotConfig.useFasterCannonTracker) {
