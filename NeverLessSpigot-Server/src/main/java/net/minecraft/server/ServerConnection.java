...
import me.ympax.neverlessspigot.handler.MinecraftPipeline;
...
public class ServerConnection {
	...
	public void a(InetAddress ip, int port) throws IOException {
		synchronized (this.getListeningChannels()) {
			...
			LOGGER.info("NeverLessSpigot: Using " + Natives.compress.getLoadedVariant() + " compression from Velocity.");
			LOGGER.info("NeverLessSpigot: Using " + Natives.cipher.getLoadedVariant() + " cipher from Velocity.");
			// Paper end
