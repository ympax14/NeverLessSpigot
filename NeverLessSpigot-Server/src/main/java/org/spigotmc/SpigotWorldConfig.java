...
public class SpigotWorldConfig {
	...
	private void itemMerge() {
		// NeverLessSpigot - optimize config defaults 2.5 -> 3.5
	...
	private void expMerge() {
		// NeverLessSpigot - optimize config defaults 3.0 -> 4.0
	...
	private void mobSpawnRange() {
		// NeverLessSpigot - optimize config defaults 4 -> 2
		mobSpawnRange = (byte) getInt("mob-spawn-range", 2);
		log("Mob Spawn Range: " + mobSpawnRange);
	}

	// NeverLessSpigot - optimize config defaults 32 -> 16, 32 -> 24, 16 -> 8
	...
	private void nerfSpawnerMobs() {
		// NeverLessSpigot - optimize config defaults false -> true
