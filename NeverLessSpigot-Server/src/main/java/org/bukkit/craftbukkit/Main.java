		...
		OptionParser parser = new OptionParser() {
			{
				...
				acceptsAll(asList("neverlessspigot", "neverlessspigot-settings"), "File for NeverlessSpigot settings").withRequiredArg()
				.ofType(File.class).defaultsTo(new File("NeverLessSpigot.yml")).describedAs("Yml file");
				// NeverLessSpigot end
			}
		};
