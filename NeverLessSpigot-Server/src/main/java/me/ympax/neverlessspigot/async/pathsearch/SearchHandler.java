package me.ympax.neverlessspigot.async.pathsearch;
...
import me.ympax.neverlessspigot.async.pathsearch.cache.SearchCacheEntryEntity;
import me.ympax.neverlessspigot.async.pathsearch.cache.SearchCacheEntryPosition;
...
public class SearchHandler {
	...
	private final ExecutorService executor = Executors.newFixedThreadPool(NeverLessSpigotConfig.pathSearchThreads,
			new ThreadFactoryBuilder().setNameFormat("NeverLessSpigot Entity Path Search Thread %d").build());
