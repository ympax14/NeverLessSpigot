...
public class MinecraftPipeline extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel channel) {
		try {
			...
			config.setOption(ChannelOption.TCP_NODELAY, NeverLessSpigotConfig.enableTCPNODELAY);
			config.setOption(ChannelOption.TCP_FASTOPEN, NeverLessSpigotConfig.modeTcpFastOpen);
			config.setOption(ChannelOption.TCP_FASTOPEN_CONNECT,NeverLessSpigotConfig.enableTcpFastOpen);
