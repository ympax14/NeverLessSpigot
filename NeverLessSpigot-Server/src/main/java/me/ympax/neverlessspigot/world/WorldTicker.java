package me.ympax.neverlessspigot.world;

import java.util.List;

import me.ympax.neverlessspigot.async.AsyncUtil;
import me.ympax.neverlessspigot.async.ResettableLatch;
...
public class WorldTicker implements Runnable {
	...
	private final ResettableLatch latch = new ResettableLatch(NeverLessSpigotConfig.trackingThreads);
	...
	@Override
	public void run() {
		run((!NeverLessSpigotConfig.disableTracking && NeverLessSpigotConfig.fullAsyncTracking));
	}
